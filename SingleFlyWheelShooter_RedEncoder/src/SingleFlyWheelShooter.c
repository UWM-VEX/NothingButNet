...
SingleFlyWheelShooter initSingleFlyWheelShooter(double kP, double kI, double kD, double kF, int errorEpsilon, int motor, int motorInverted, int encoderTop, int encoderBotton, int encoderInverted)
{
