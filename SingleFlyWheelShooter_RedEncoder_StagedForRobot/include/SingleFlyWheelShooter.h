...
SingleFlyWheelShooter initSingleFlyWheelShooter(double kP, double kI, double kD, double kF, double errorEpsilon, int motor, int motorInverted, int topEncoder, int bottomEncoder, int encoderInverted);
...
void shooterSetErrorEpsilon(SingleFlyWheelShooter*, double);
